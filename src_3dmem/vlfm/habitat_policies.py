...
class HabitatMixin:
    ...
    def act(
        ...
        try:
            action, rnn_hidden_states = parent_cls.act(obs_dict, rnn_hidden_states, prev_actions, masks, skip, deterministic)
    ...
    def _initialize(self) -> Tensor:
        ...
        rgb_image = self._observations_cache["object_map_rgbd"][0][0]
        self._images.append(rgb_image)
        self._observations_list.append(self._observations_cache["value_map_rgbd"][0])
    ...
    def _reinitialize(self) -> Tensor:
        """Turn left 30 degrees 12 times to get a 360 view"""
        rgb_image = self._observations_cache["object_map_rgbd"][0][0]
        self._images.append(rgb_image)
        self._observations_list.append(self._observations_cache["value_map_rgbd"][0])
        self._num_rotates += 1
        self._done_reinitializing = (self._num_rotates % 12 == 0)
        return TorchActionIDs.TURN_LEFT
